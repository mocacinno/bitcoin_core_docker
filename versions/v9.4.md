...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v9.4)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v9.4)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v9.4?color=green)<br>
...
```bash
bash-4.4$ bitcoind -?
Bitcoin Core Daemon version v0.9.4.0-g41f94edf22101-beta
