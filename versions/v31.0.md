...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v31.0)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v31.0)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v31.0?color=green)<br>

- **Version:** v31.0
- **Tag:** v31.0
- **Release Date:** 2026-04-20
- **Docker Pull Command**:
  - `docker pull ghcr.io/mocacinno/mocacinno/bitcoin_core_docker:v31.0`
  - `docker pull mocacinno/btc_core:v31.0`
- **Compiled by**: Mocacinno
- **Changelog**: [View Changelog](https://github.com/bitcoin/bitcoin/blob/v31.0/doc/release-notes.md)
...
Options:
  ...
  -txospenderindex
       Maintain a transaction output spender index, used by the
       gettxspendingprevout rpc call (default: 0)
...
Connection options:
  ...
  -asmap=<file>
       Specify asn mapping used for bucketing of the peers. Relative paths will
       be prefixed by the net-specific datadir location. If a bool arg
       is given (-asmap or -asmap=1), the embedded mapping data in the
       binary will be used.
...
Block creation options:
  ...
  -blockreservedweight=<n>
       ...
       transaction the mining software may add to the block. Only
       affects mining RPC clients, not IPC clients. (default: 8000).
...
[Previous version: v31.0](./v31.0.md) | [Next version: v31.0](./v31.0.md)
