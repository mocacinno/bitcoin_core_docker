...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v8.4)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v8.4)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v8.4?color=green)<br>
...
```bash
bash-4.4$ bitcoind -?
Bitcoin version v0.8.4.0-g839c7d1fa8bf9-beta
