...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v3.16)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v3.16)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v3.16?color=green)<br>
...
- **Changelog**: [View Sourcecode](https://github.com/mocacinno/bitcoin_core_history/tree/v0.3.16/)
