...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v29.2)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v29.2)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v29.2?color=green)<br>

- **Version:** v29.2
- **Tag:** v29.2
- **Release Date:** 2025-10-14
- **Docker Pull Command**:
  - `docker pull ghcr.io/mocacinno/mocacinno/bitcoin_core_docker:v29.2`
  - `docker pull mocacinno/btc_core:v29.2`
- **Compiled by**: Mocacinno
- **Changelog**: [View Changelog](https://github.com/bitcoin/bitcoin/blob/v29.2/doc/release-notes.md)
...
[Previous version: v29.1](./v29.1.md) | [Next version: v30.0](./v30.0.md)
