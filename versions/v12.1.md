...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v12.1)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v12.1)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v12.1?color=green)<br>
...
```bash
bash-4.4$ bitcoind -?
Bitcoin Core Daemon version v0.12.1.0-g9779e1e1f320a
