...
[![Build and Publish Docker Images](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml/badge.svg?branch=v2.5)](https://github.com/mocacinno/bitcoin_core_docker/actions/workflows/build-and-publish.yml)<br>
![Last commit](https://img.shields.io/github/last-commit/mocacinno/bitcoin_core_docker/v2.5)<br>
![Image size](https://img.shields.io/docker/image-size/mocacinno/btc_core/v2.5?color=green)<br>
...
- **Changelog**: [View Sourcecode](https://github.com/bitcoin/bitcoin/blob/v0.2.5/changelog.txt)
...
<link rel="stylesheet" href="https://mocacinno.com/asciinema-player.css">
   ...
   <script>
      AsciinemaPlayer.create('./casts/v0.2.5.cast', document.getElementById('fullnode'));
   </script>
{% endraw %}
...
![v0.2.5 gui screencap main screen](./images/v0.2.5_1.png)

#### about

![v0.2.5 gui screencap about screen](./images/v0.2.5_2.png)

#### options

![v0.2.5 gui screencap options screen](./images/v0.2.5_3.png)
