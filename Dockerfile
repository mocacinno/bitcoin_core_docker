...
LABEL org.opencontainers.image.version="v0.2.5"
LABEL org.opencontainers.image.source="https://github.com/mocacinno/bitcoin_core_history"
LABEL org.opencontainers.image.revision="manual-trigger-20251204"
...
# -------------------------------
# Build Bitcoin Core v0.2.5
# -------------------------------
WORKDIR /src
RUN curl -fsSL https://github.com/mocacinno/bitcoin_core_history/archive/refs/heads/v0.2.5.zip -o bitcoin.zip && \
    echo "5a74c1292ab2526c9289a7283095fe441d5650184b297f5b7eaa4ef3cf4bdcd5 bitcoin.zip" | sha256sum -c - && \
    unzip bitcoin.zip && \
    cd bitcoin_core_history-0.2.5 && \
    mkdir -p obj/nogui && \
    ...
    strip bitcoin && \
    ln -s /src/bitcoin_core_history-0.2.5/bitcoin /usr/local/bin
