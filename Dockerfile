...
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.12.zip
RUN unzip v0.3.12.zip
WORKDIR /bitcoin-0.3.12
...
COPY --from=builder /bitcoin-0.3.12/bitcoind /usr/local/bin
