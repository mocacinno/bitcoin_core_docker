...
RUN git checkout tags/v0.11.2 -b v0.11.2 #v0.11.2
...
RUN ./configure  --enable-util-cli --enable-util-tx --enable-util-wallet --enable-util-util #v0.11.2
RUN make -j "$(($(nproc) + 1))" #v0.11.2
WORKDIR /bitcoin/src
