...
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.14.zip
RUN unzip v0.3.14.zip
WORKDIR /bitcoin-0.3.14
...
COPY --from=builder /bitcoin-0.3.14/bitcoind /usr/local/bin
