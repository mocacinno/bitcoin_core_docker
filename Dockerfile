...
RUN git checkout tags/v0.11.0 -b v0.11.0 #v0.11.0
...
RUN ./configure  --enable-util-cli --enable-util-tx --enable-util-wallet --enable-util-util #v0.11.0
RUN make -j "$(($(nproc) + 1))" #v0.11.0
WORKDIR /bitcoin/src
