...
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.19.zip
RUN unzip v0.3.19.zip
WORKDIR /bitcoin-0.3.19
...
COPY --from=builder /bitcoin-0.3.19/bitcoind /usr/local/bin
