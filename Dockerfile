...
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.17.zip
RUN unzip v0.3.17.zip
WORKDIR /bitcoin-0.3.17
...
COPY --from=builder /bitcoin-0.3.17/bitcoind /usr/local/bin
