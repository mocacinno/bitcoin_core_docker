...
COPY --from=builder /bitcoin-25.1/src/bitcoin-util /usr/local/bin
COPY --from=builder /bitcoin-25.1/src/bitcoin-cli /usr/local/bin
COPY --from=builder /bitcoin-25.1/src/bitcoin-tx /usr/local/bin
COPY --from=builder /bitcoin-25.1/src/bitcoind /usr/local/bin
