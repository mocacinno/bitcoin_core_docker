...
#bitcoin core v0.3.15
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.15.zip
RUN unzip v0.3.15.zip
WORKDIR /bitcoin-0.3.15
...
COPY --from=builder /bitcoin-0.3.15/bitcoind /usr/local/bin
