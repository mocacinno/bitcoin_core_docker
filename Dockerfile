...
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.20.zip
RUN unzip v0.3.20.zip
WORKDIR /bitcoin-0.3.20
...
COPY --from=builder /bitcoin-0.3.20/bitcoind /usr/local/bin
