...
#bitcoin core v0.3.7
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.7.zip
RUN unzip v0.3.7.zip
WORKDIR /bitcoin-0.3.7
#run g++ -v -c util.cpp
...
COPY --from=builder /bitcoin-0.3.7/bitcoind /usr/local/bin
