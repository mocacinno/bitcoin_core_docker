...
RUN ./configure  --enable-util-cli --enable-util-tx --enable-util-wallet --enable-util-util CXX="g++ -std=c++98" #v0.10.5
...
COPY --from=builder /usr/lib64/libboost_system.so.1.57.0 /usr/lib64/
