...
WORKDIR /
RUN wget https://github.com/bitcoin/bitcoin/archive/refs/tags/v0.3.18.zip
RUN unzip v0.3.18.zip
WORKDIR /bitcoin-0.3.18
...
COPY --from=builder /bitcoin-0.3.18/bitcoind /usr/local/bin
