...
RUN git checkout tags/v0.11.3 -b v0.11.3 #v0.11.3
...
RUN ./configure  --enable-util-cli --enable-util-tx --enable-util-wallet --enable-util-util #v0.11.3
RUN make -j "$(($(nproc) + 1))" #v0.11.3
WORKDIR /bitcoin/src
